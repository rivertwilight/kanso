...
In this eassy I'll share what it takes to build things that last. I'm not talking about PMF or DAU. These has nothing to do with the survival in this context, which are how the world judge whether a goods sell.
...
This doesn't mean simplicity is always the answer. Complex, feature-rich products like Photoshop and Linux have lasted decades. But they survive because of relentless maintenance and deep, irreplaceable value. If you don't have those resources, simplicity is your best bet.
...
This sounds conter-inituitive: AI can speed up the shipping, why we slow it down?

Less hustles means less hype and more crafts.

> When you want to hurry something, that means you no longer care about it and want to get on to other things.
>
> _Robert M. Pirsig, Zen and the Art of Motorcycle Maintenance_

These "blank time" is where inspiration grown. Value those time you feel "not good" to make the project. Do something else. Read a book, re-visit a moive, take a walk. The miracle is inside there.

...
访问这些产品的官网，一路默认安装即可。如果遇到无法打开，可能需要在 macOS 的设置-隐私里允许未知来源应用。
...
然后，生成 ssh 密钥，用于推送到版本管理仓库。将公钥添加到 GitHub 或其他托管平台即可。执行命令后，会输出公钥所在的目录。
...
![](/image/post/114f6fdc-1175-40d7-8bec-56013eb2cad2_Untitled.png)
